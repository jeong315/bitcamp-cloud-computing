...
//$('#add-btn').click(() => {
//    $('#reset-btn').click();//클릭할 때 이메소드를 호출해주세요x reset-btn에 대해서 클릭 (강제로)이벤트를 발생시키는 것이다.
//                            //reset은 지운다기보다 초기화
//    $('.form-control-plaintext').addClass('form-control')//폼 컨트롤을 추가시키고 
//        .removeClass('form-control-plaintext');//기존의 폼 컨트롤러플레인텍스트는 삭제시켜라.
//}) 