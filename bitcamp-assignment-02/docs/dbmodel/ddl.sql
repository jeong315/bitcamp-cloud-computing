...
CREATE TABLE P2_BIZCARD (
    BCNO  INTEGER     NOT NULL COMMENT '명함 번호', -- 명함 번호
    MNO   INTEGER     NOT NULL COMMENT '회원 번호', -- 회원 번호
    NAME  VARCHAR(50) NOT NULL COMMENT '이름', -- 이름
    MTEL  VARCHAR(30) NULL     COMMENT '휴대 전화', -- 휴대 전화
    TEL   VARCHAR(30) NULL     COMMENT '일반 전화', -- 일반 전화
...
ALTER TABLE P2_BIZCARD
    MODIFY COLUMN BCNO INTEGER NOT NULL AUTO_INCREMENT COMMENT '명함 번호';
